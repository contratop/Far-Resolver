 ...
 # CHECK CMD INIT
    ...
    if($choice -eq 2){ # CHOICE 2 ###############################
        ...
        while($whilelocura){
            ...
            # CHECK END
            # END ##################################################
            if($defenderstatus -eq 1){ #MENU OPTION 1 (Realtime monitoring)
            ...
            if($behavior -eq 1){ #MENU OPTION 2 (Behavior monitoring)
            ...
            if($ioav -eq 1){ #MENU OPTION 3 (IOAV protection)
            ...
            if($script -eq 1){ #MENU OPTION 4 (Script scanning)
            ...
            if($archive -eq 1){ #MENU OPTION 5 (Archive scanning)
            ...
            if($block -eq 1){ #MENU OPTION 6 (Block at first seen)
            ...
            if($auto -eq 1){ #MENU OPTION 7 (Auto exclusions)
            ...
            if($restore -eq 1){ #MENU OPTION 8 (Restore point)
            ...
            if($removable -eq 1){ #MENU OPTION 9 (Removable drive scanning)
